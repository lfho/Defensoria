...
<crud
    name="posts"
    :resource="{default: 'posts', get: 'get-posts'}"
    inline-template>
    <div>
        <!-- begin breadcrumb -->
        ...
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('posts')'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-posts" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('posts')
            </button>
        </div>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('posts'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
        ...
        <!-- begin #modal-view-posts -->
        <div class="modal fade" id="modal-view-posts">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('posts')</h4>
        ...
        <!-- end #modal-view-posts -->

        <!-- begin #modal-form-posts -->
        <div class="modal fade" id="modal-form-posts">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-posts">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('posts')</h4>
...
<script>
    ...
    $('#modal-form-posts').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
