...
<crud name="polls" :resource="{default: 'polls', get: 'get-polls',show: 'polls'}" inline-template v-show="!query" ref="crud">
    <div>
        <!-- begin breadcrumb -->
        ...
        <!-- end #modal-form-polls -->
         ...
         @if (Auth::user()->hasRole('Administrador intranet de encuestas'))    
            <dynamic-modal-form
                ...
                :is-update="true"
                confirmation-message-saved="Estás a punto de enviar la Encuesta de la entidad a los funcionarios que ingresó en la información general de la encuesta. <br> <br> ¿Estás seguro de enviar?"
                @saved="
                    if($event.isUpdate) {
...
<search-result-universal v-show="query" ref="resultado" :id-registro="{{ Request::get('id') ?? 0 }}" tipo-modulo="polls"></search-result-universal>
