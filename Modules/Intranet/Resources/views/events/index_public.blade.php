...
<crud
    ...
    :init-values="{notification: false}"
    inline-template 
    v-show="!query" 
    ref="crud">
    <div>
        ...
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('Events')'}}</h1>
        <!-- end page-header -->
        ...
        <div class="m-t-20">
            ...
            <a href="{{ route('calendar-events') }}">
                <button  type="button" class="btn btn-primary m-b-10" >
                    <i class="fas fa-calendar-alt mr-2"></i> @lang('Ver calendario')
                </button>
            </a>
        </div>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('Events'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
        ...
        <div class="modal fade" id="modal-view-events">
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('Events')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('intranet::events.show_fields')
                    </div>
        ...
        <!-- begin #modal-form-events -->
        <div class="modal fade" id="modal-form-events">
            <div class="modal-dialog modal-xl">
                <form @submit.prevent="save()" id="form-events">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('Events')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('intranet::events.fields')
                        </div>
                        <div class="modal-footer">
        ...
        <!-- end #modal-form-events -->
    </div>
</crud>

<search-result-universal v-show="query" ref="resultado" :id-registro="{{ Request::get('id') ?? 0 }}" tipo-modulo="events"></search-result-universal>
...
<script>
    ...
    $('#modal-form-events').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
