...
<crud
    ...
    inline-template v-show="!query" ref="crud">
    <div>
        <!-- begin breadcrumb -->
...
<search-result-universal v-show="query" ref="resultado" :id-registro="{{ Request::get('id') ?? 0 }}" tipo-modulo="notices-all" ruta-get-datos="consulta-buscador"></search-result-universal>
