...
<crud
    name="categories"
    :resource="{default: 'categories', get: 'get-categories'}"
    inline-template>
    <div>
        <!-- begin breadcrumb -->
        ...
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('Categories')'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-categories" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('Categories')
            </button>
        </div>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('Categories'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
            ...
            <div class="panel-body">
                ...
                @include('intranet::categories.table')
            </div>
        ...
        <!-- begin #modal-view-categories -->
        <div class="modal fade" id="modal-view-categories">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('Categories')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('intranet::categories.show_fields')
                    </div>
        ...
        <!-- end #modal-view-categories -->

        <!-- begin #modal-form-categories -->
        <div class="modal fade" id="modal-form-categories">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-categories">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('Categories')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('intranet::categories.fields')
                        </div>
                        <div class="modal-footer">
