...
<div class="form-group row m-b-15">
    ...
    <div class="col-md-9">
        @{!! Form::select('{{ $fieldName }}', @php echo htmlspecialchars_decode($selectValues) @endphp, null, [':class' => "{'form-control':true, 'is-invalid':dataErrors.{{ $fieldName }} }", 'v-model' => 'dataForm.{{ $fieldName }}', 'required' => true]) !!}
