...
return [
    ...
    */
    ...
    'password.mixed'   => 'La :attribute debe tener al menos 12 caracteres y contener una letra mayúscula, una minúscula, un número y un símbolo - /; 0) & @.?! %*',
    'password.letters' => 'La :attribute debe tener al menos 12 caracteres y contener una letra mayúscula, una minúscula, un número y un símbolo - /; 0) & @.?! %*',
    'password.symbols' => 'La :attribute debe tener al menos 12 caracteres y contener una letra mayúscula, una minúscula, un número y un símbolo - /; 0) & @.?! %*',
    'password.numbers' => 'La :attribute debe tener al menos 12 caracteres y contener una letra mayúscula, una minúscula, un número y un símbolo - /; 0) & @.?! %*',
