            ...
            <form @submit.prevent="save()" id="form-users" enctype="multipart/form-data">
               <div class="modal-content border-0">
                  <div class="modal-header bg-blue">
                     <h4 class="modal-title text-white">Formulario de técnicos 1</h4>
   ...
   export default class AddTechnicalTicComponent extends Vue {
      ...
      public loadAddUser(dataElement: object): void {
         ...
         if (dataElement) {
            ...
            this.dataForm = dataElement;
            (this.$parent as any)["dataForm"] = dataElement;
      ...
      */
      ...
      private _initValues(): void {
         ...
         this.dataErrors = utility.clone((this.$parent as any).dataErrors);
      }
