...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? "{0} elemento seleccionado" : "{0} artículos seleccionados";
    },
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Límite alcanzado ({n} item max)' : 'Límite alcanzado ({n} artículos máx.)',
        (numGroup == 1) ? 'Límite de grupo alcanzado ({n} item max)' : 'Group limit reached ({n} items max)'
      ];
    },
