<template>
   <div>
      <div class="form-group row col-md-12">
         <label :for="name" class="col-sm-12"></label>
         <div class="col-sm-12">
            <input type="file" multiple="multiple"  :id="name" @change="uploadFieldChange">
            <hr>
            <div class="col-md-12">
               <div class="attachment-holder animated fadeIn" v-cloak v-for="(attachment, index) in attachments"> 
                  <span class="label label-primary">{{ attachment.name + ' (' + Number((attachment.size / 1024 / 1024).toFixed(4)) + ' MB)'}}</span> 
