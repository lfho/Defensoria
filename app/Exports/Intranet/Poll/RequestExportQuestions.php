...
class RequestExportQuestions implements FromView, WithEvents {
     ...
     */
    public function __construct($view ,$data, $column='b') {
        $this->view = $view;
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A1:'.strtoupper($this->column).(count($this->data)+1))->applyFromArray([
                    'borders' => [
                        'allBorders' => [
