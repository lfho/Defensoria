...
class RequestExportPQRS implements FromView, WithEvents {
     ...
     */
    public function __construct($view ,$data, $column="m") {
        $this->view = $view;
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Encabezado No.2
                $cellRangeSubHeader = 'A2:'.$this->column.'2'; // All Sub-headers
                $event->sheet->getDelegate()->getStyle($cellRangeSubHeader)->applyFromArray([
